...
export default function Experience(props: any) { 
  ...
  return (
    ...
    >
      ...
      <Section>
        <Row>
          <Col><Text>Cantidad a pagar</Text></Col>
          <Col align='flex-end'><Text>79,99€</Text></Col>
        </Row>
        <Row>
          <Col><Text>Ahorro anual</Text></Col>
          <Col align='flex-end'><Text>39,89€</Text></Col>
        </Row>
      </Section>
      <Section>
        <Row>
          <Col><Text>Pago hoy</Text></Col>
          <Col align='flex-end'><Text>79,99€ 0€</Text></Col>
        </Row>
      </Section>
      <Section>
        <Row>
          <Col><H3>Crédito / Débito</H3></Col>
        </Row>
        <Row>
